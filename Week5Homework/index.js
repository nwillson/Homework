...
const phoneNumbers = data.map((users) => users.phone);
...
data.forEach(userInfo => {
  ...
  console.log ("Website is " + website + ", and Email is " + email);
});
...
const user9 = data2.filter(task => task.userId = "9");

//then find the number of user 9's incomplete tasks
const user9incomplete = user9.filter (tasks => tasks.completed = "false");
...
//create a list of user 5's posts
 const user5 = data3.filter (userInfo => userInfo.userId = "5");
 
//then, create a list of title and body pairs
 user5.forEach(user5Info => {
  const user5Title = user5Info.title;
  const user5Body = user5Info.body;
  const pairs = ("User 5 title: " + user5Title + "User 5 body: " + user5Body);
  console.log(pairs);
 });